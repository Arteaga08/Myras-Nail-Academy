...
export function CourseContentSection({ course }: CourseContentProps) {
  ...
  return (
    ...
    <section className="overflow-x-clip bg-linear-to-b from-nude-50/50 to-rose-50/30 px-4 py-16 sm:px-6 lg:py-24">
                    ...
                    {lessons.map((lesson, idx) => (
                      ...
                      >
                        ...
                        <div className="flex shrink-0 flex-col items-end gap-1 sm:flex-row sm:items-center sm:gap-4">
                          {lesson.isFree && (
                            <span className="rounded-full bg-gold-100 px-2 py-0.5 text-[10px] font-bold text-gold-700 sm:px-3 sm:py-1 sm:text-xs">
                              GRATIS
                            </span>
                          )}
                          {lesson.duration > 0 && (
